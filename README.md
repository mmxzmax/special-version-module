...
[
      {
        serviceName:'FontSizeService',//service name
        position: 1,//position of ui
        groupName: 'Шрифт',//name rendered on ui group
        params: {
          cacheName: 'fontsize',//name of local storage param that save state
          params:[
            {
              buttonTittle: 'A',
              buttonAltText: 'размер шрифта стандартный',//text will read by text read service
              buttonClass: 'special-version__button_square,size-small',
              value: 1,//value for this param
              styleSheet: '1.css'//stylesheet url connects to page when this param is on 
            },
            {
              buttonTittle: 'A',
      ...
      },
      {
        ...
        params: {
          ...
          fontList: [//list of custom font css files to connect to the page
            '',''
          ]
        }
      },
      {
        ...
        params: {
          ...
          scheme: {
            bw: ['#ffffff','#000000'],//colors for text and block
            wb: ['#000000','#ffffff'],
            bb: ['#9dd1ff','#195183'],
            bwl: ['#f7f3d6','#4d4b43'],
            bg: ['#3b2716','#a9e44d']
      ...
      },
      {
        ...
        params: {
          ...
          params:[
            ...
            {
              buttonTittle: 'Двойной',
              buttonAltText: 'интервал Двойной',
              buttonClass: '',
              value: 2,
              styleSheet: ''
            }
